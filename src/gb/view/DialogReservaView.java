...
public class DialogReservaView extends Dialog {
	 ...
	 * @param style
	 */
	public DialogReservaView(Shell parent) {
	...
	private void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(DialogReservaView.class, "/img/ic_exit_to_app_black_24dp.png"));
		...
		lblNewLabel_3.setText("Limite retirada:   ");
		txtLimite = new Text(grpUsurio, SWT.BORDER);
		...
		txtLimite.setLayoutData(gd_txtPrevDevolucao);
		new Label(grpUsurio, SWT.NONE);
