...
public class DialogEmprestimoView extends Dialog {
	...
	private void createContents() {
		...
		btnBuscaUsuario.setImage(SWTResourceManager.getImage(DialogEmprestimoView.class, "/img/ic_search_black_18dp.png"));
		...
		btnBuscaExemplar.setImage(SWTResourceManager.getImage(DialogEmprestimoView.class, "/img/ic_search_black_18dp.png"));
